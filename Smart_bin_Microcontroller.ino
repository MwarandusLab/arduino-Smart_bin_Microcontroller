...
const int STEPPER_PIN_1 = 7; //10;
const int STEPPER_PIN_2 = 4; //11;
const int STEPPER_PIN_3 = 3; //12;
const int STEPPER_PIN_4 = 2; //13;
...
//ultrasonic sensor 1
const int trigPin_1 = 12; //5; // Trigger pin of the ultrasonic sensor
const int echoPin_1 = 11; //4; // Echo pin of the ultrasonic sensor

long duration_1 ;
long distance_1 ;

//ultrasonic sensor 2
const int trigPin_2 = 5; //7; // Trigger pin of the ultrasonic sensor
const int echoPin_2 = 13; //6; // Echo pin of the ultrasonic sensor
...
void loop() {
  ...
  if(distance_1 < 5 && Sent == 0){ //Dry Section
    mySerial.println("AT+CMGF=1"); // Configuring TEXT mode
    updateSerial();
    mySerial.println("AT+CMGS=\"+254704957199\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
    updateSerial();
    ...
    Sent = 1;
    delay(2000);
  }else if(distance_2 < 5 && Sent == 0){ //Wet Section
    mySerial.println("AT+CMGF=1"); // Configuring TEXT mode
    updateSerial();
    mySerial.println("AT+CMGS=\"+254704957199\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
    updateSerial();
